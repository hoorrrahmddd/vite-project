...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f4f4f4] px-4 relative overflow-hidden">
      ...
      >
        <h2 className="text-2xl font-bold mb-6 text-center text-[#2D2541]">Welcome Back</h2>
        ...
        <p className="text-sm text-center text-gray-500 mt-6">
          Don't have an account? <span className="text-[#2D2541] cursor-pointer" onClick={() => navigate('/signup')}>Sign Up</span>
        </p>
      </motion.div>
    </div>
  );
